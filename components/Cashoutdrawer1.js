...
import Logoutsuccesfuly from "./Logoutsuccesfuly";
import { Color, Border, FontFamily, FontSize, Padding } from "../GlobalStyles";

const Cashoutdrawer1 = ({ onClose }) => {
  ...
  return (
    <>
      <View style={styles.cashoutdrawer}>
        ...
        />
        <Text style={styles.cashOutDrawer}>Cash Out Drawer</Text>
        <TextInput
          style={styles.paymentFixed}
          placeholder="Enter Amount"
          placeholderTextColor="#818181"
        />
        <View style={[styles.numberpadCashout, styles.submitWrapperPosition]}>
        ...
        <Pressable
          style={[styles.submitWrapper, styles.submitWrapperPosition]}
      ...
      <Modal animationType="fade" transparent visible={frameContainerVisible}>
        <View style={styles.frameContainerOverlay}>
          ...
          />
          <Logoutsuccesfuly onClose={closeFrameContainer} />
        </View>
      </Modal>
    </>
  );
